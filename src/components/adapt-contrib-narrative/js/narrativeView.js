    ...
    var NarrativeView = ComponentView.extend({
        ...
        preRender: function() {
            ...
            this.listenTo(Adapt, {
                ...
                'notify:toggleAudio': this.toggleAudio1
            });
            this.renderMode();
        ...
        calculateMode: function() {
            ...
            var mode = (Adapt.device.screenWidth > 760) ?
                MODE.LARGE :
                MODE.SMALL;
        ...
        playAudio: function(index) {
            if(this.isAudio) {
                ...
                console.log("playAudio, currentAudio: ", currentAudio);

                this.$el.parents().find('.global-audio-player audio').attr('src', '');
                if(currentAudio !='' && currentAudio.length > 0) this.$el.parents().find('.global-audio-player audio').attr('src', currentAudio);
            }
        },
        ...
        onInview: function(event, visible, visiblePartX, visiblePartY) {
            console.log("visible: ", visible, ", visiblePartY: ", visiblePartY);
            if(visible) {
