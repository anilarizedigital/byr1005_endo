    ...
    var MediaView = ComponentView.extend({
        ...
        preRender: function() {
            this.listenTo(Adapt, {
                ...
                'audioplayer:playing': this.onAudioPlay
            });
        ...
        postRender: function() {
            this.setupPlayer();
            this.setupInviewPlay();
        },

        setupInviewPlay: function() {
            var _this = this;
            this.$('.component-widget').on('inview.componentView', function(event, visible) {
                if(!visible) {
                    if (_this.mediaElement && _this.mediaElement.player) {
                        _this.mediaElement.player.pause();
                        _this.onMediaElementPause();
                    }
                }
            });
        },
