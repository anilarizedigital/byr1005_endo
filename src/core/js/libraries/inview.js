...
(function() {
    ...
    var measurements = {
        ...
        get: function get($element) {
            ...
            // console.log('$element: ', $element, ', height: ', height, ', top: ', top, ', bottom: ', bottom, ', percentFromTop: ', percentFromTop, ', percentFromBottom: ', percentFromBottom, ', inviewVertical: ', inviewVertical, ', percentInviewVertical: ', percentInviewVertical, ', elementArea: ', elementArea, ', inviewArea: ', inviewArea, ', percentInview: ', percentInview, ', offScreenSide: ', offScreenSide);
